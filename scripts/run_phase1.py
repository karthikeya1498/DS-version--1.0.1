...
def main() -> dict:
    ...
    manifest = process(
        root / "data/raw/mobility/hour.csv", root / "data/processed/mobility_hour_clean.csv"
    )
    ...
    status = {
        ...
        "traffic_state": simulation["traffic_state"],
        "demand_multiplier": simulation["demand_multiplier"],
        "graph_built": simulation["graph_built"],
        "data_validated": manifest["validated"],
        "simulation": simulation["simulation"],
        "source_rows": manifest["rows"],
    }
    output = root / "data/processed/phase1_status.json"
