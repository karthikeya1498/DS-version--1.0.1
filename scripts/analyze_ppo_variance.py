...
def main() -> None:
    ...
    report = {
        'seed_rows': [{key: row[key] for key in ('seed', 'ppo_mean_return', 'baseline_mean_return', 'delta_vs_baseline', 'ppo_std_return', 'policy_loss_sd', 'value_loss_sd')} for row in rows],
