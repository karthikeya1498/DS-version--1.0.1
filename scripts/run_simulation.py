...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(); parser.add_argument('--seed', type=int, default=42); parser.add_argument('--duration-hours', type=int, default=8); parser.add_argument('--zones', type=int, default=5); parser.add_argument('--vehicles', type=int, default=10); parser.add_argument('--orders-per-hour', type=int, default=20); args = parser.parse_args()
    print(json.dumps(run(args.seed, args.duration_hours, args.zones, args.vehicles, args.orders_per_hour), indent=2))
