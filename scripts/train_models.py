...
LAG_FEATURES = [
    "demand_lag_1",
    "demand_lag_24",
    "demand_rolling_24_mean",
    "demand_rolling_168_mean",
]
...
def evaluate(path="data/raw/mobility/hour.csv", output="data/processed/forecast_metrics.json"):
    ...
    models = {
        "gradient_boosting": GradientBoostingRegressor(
            random_state=42, n_estimators=200, max_depth=3, learning_rate=0.05
        ),
        "random_forest": RandomForestRegressor(
            random_state=42, n_estimators=100, n_jobs=-1, max_depth=16
        ),
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="data/processed/forecast_metrics.json")
