...
with left:
    ...
    nx.draw(graph, pos, ax=ax, node_size=35, width=0.7, node_color="#38bdf8")
...
with right:
    ...
    if forecast_path.exists():
        ...
        st.info("Run the forecasting pipeline to populate metrics.")
...
if bench_path.exists():
    ...
    st.info("Run the graph benchmark to populate routing results.")
