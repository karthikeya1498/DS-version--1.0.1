...
from src.simulation.models import SimulationConfig, Location, TimeWindow
from src.simulation.simulator import LogisticsSimulator

def test_simulator_is_reproducible():
    config = SimulationConfig(seed=7, zones=3, vehicles=4, orders_per_hour=3, duration=timedelta(hours=1))
