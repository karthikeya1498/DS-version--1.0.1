...
def test_osm_xml_importer_builds_bidirectional_roads(tmp_path: Path):
    ...
    osm.write_text('''<osm><node id="1" lat="0" lon="0"/><node id="2" lat="0" lon="1"/><node id="3" lat="1" lon="1"/><way id="10"><nd ref="1"/><nd ref="2"/><nd ref="3"/><tag k="highway" v="residential"/></way></osm>''', encoding='utf-8')
