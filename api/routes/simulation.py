...
def run_simulation(request: SimulationRequest):
    config = SimulationConfig(seed=request.seed, duration=timedelta(hours=request.duration_hours), zones=request.zones, vehicles=request.vehicles, orders_per_hour=request.orders_per_hour)
